...
public class HttpPostConn {
    ...
    public static HttpResult SendHttpsRequest(String httpMethod, String refId, String targetUrl, HashMap httpHeader, String requestBody, int connectTimeout, int waitTimeout) {
        ...
        try {
            ...
            Logger.application.info(Logger.pattern, WhatsappServiceApplication.VERSION, loglocation,  "Sending Request to :" + targetUrl, "");
            ...
            Logger.application.info(Logger.pattern, WhatsappServiceApplication.VERSION, loglocation,  "Response String :" + httpMsgResp.toString(), "");
            ...
            if (ex.getMessage().equals("Read timed out")) {
                ...
                Logger.application.error(Logger.pattern, WhatsappServiceApplication.VERSION, loglocation,  "Exception  :" + ex.getMessage(), "");
